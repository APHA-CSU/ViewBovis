...
// Real Data Extracted From ViewBovine For UK705113600438
// const mov1 = [
//   [53.090685, -3.032281, "Farm1"],
//   [53.167169, -3.140021, "Farm2"],
...
// fetch(database, ID_arg)
// // spinner UI
// new Promise(dataReturned).json
const mov1 = [
...
const cowIcon = L.icon({
    iconUrl: "./src/img/Cow_GIS_Team.svg",
...
document.getElementById("btn_show-movements").addEventListener("click", function(){
      ...
      <div>
        ...
        <div class="tab-content" id="popTabContent">     
          ...
          <div class="tab-pane fade show" id="navInfoContent" role="tabpanel" aria-labelledby="navInfo" tabindex="0">
            ...
            <img src="./src/img/peter-lloyd-qeABAF-3bEs-unsplash-min.jpg" alt="A photo of a cow" width="100%">
          </div>
        </div>           
      `;
    ...
    cattleMovLine.arrowheads({
      ...
      fillColor: "#0096FF",
      // color: "black",
      frequency: "30000m", // options: 10, "500m", "50px", "allvertices", "endonly"
    }).addTo(map);
