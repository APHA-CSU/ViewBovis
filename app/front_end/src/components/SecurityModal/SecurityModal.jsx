              ...
              <div className="modal-body">
                <div className="govuk-notification-banner govuk-notification-banner--success">
                  ...
                  <div className="govuk-notification-banner__content">
                    ...
                    <div>
                      <p>
                        ViewBovis displays Official Sensitive data which must
                        only be viewed by those with appropriate access. Failure
                        to comply risks shutdown of the ViewBovis service by
                        APHA IT, due to mishandling of Official Sensitive data.
                      </p>
                    </div>
