              ...
              <Col className="col-9">
                <div className="home-description-container">
                  <p className="home-description fs-5">
                    ...
                    tool used to visualise whole genome sequencing (WGS) data
                    from <em>Mycobacterium bovis</em>. You can view and explore
                    both a phylogenetic tree and a map to understand genetic
                    relatedness and locate samples geographically. This
                    visualisation enables you to view data on both bovine and
                    non-bovine samples.
                  </p>
                </div>
              </Col>
            ...
            <Row className="gx-6">
                ...
                <div className="nextstrain-box">
                  <Row>
                    ...
                    <Col className="col-4">
                      ...
                      <p className="fs-6">
                        Use the search box to find your sample of interest.
                        Click a link in the table to view the phylogenetic tree
                        in Nextstrain.
                      </p>
                      <ul
                        className="fs-6"
                      ...
                      >
                        ...
                        <li>
                          Clicking on CPH or County highlights all samples in
                          the same CPH or County, respectively.
                        </li>
                        <li>
              ...
              <Col className="col-3">
                <div className="nextstrain-box">
                  ...
                  <p className="fs-6">
                    The resources below have been developed to help you
                    understand how to use Nextstrain and how to interpret the
                    phylogeny.
                    <br></br>
                  </p>
                  <p className="fs-6">
