!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define("GOVUKFrontend", [
        "exports"
    ], e) : e(t.GOVUKFrontend = {});
}(this, function(t) {
    "use strict";
    ...
    a.prototype.t = function(t, e) {
        ...
        var t, e = this.locale, n = e.split("-")[0];
        for(t in a.pluralRulesMap)if (Object.prototype.hasOwnProperty.call(a.pluralRulesMap, t)) {
            for(var o = a.pluralRulesMap[t], i = 0; i < o.length; i++)if (o[i] === e || o[i] === n) return t;
        }
    }, a.pluralRulesMap = {
        arabic: [
            "ar"
        ...
        "defineProperty" in Object && function() {
            ...
            var e = String(e), o = "value" in n || "writable" in n, i = "get" in n && typeof n.get, s = "set" in n && typeof n.set;
            if (i) {
        ...
        "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
            value: function(e) {
                var t = Array, n = Object, o = n.prototype, t = t.prototype, i = function i() {}, s = o.toString, r = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag, a = Function.prototype.toString, l = function l(t) {
                    try {
                        return a.call(t), !0;
                    } catch (e) {
                        return !1;
                    }
                }, c = t.slice, u = t.concat, d = t.push, o = Math.max, h = this;
                if (!function g(t) {
        ...
        (!("DOMTokenList" in this) || "classList" in (t = document.createElement("x")) && (t.classList.toggle("x", !1) || t.className)) && ("DOMTokenList" in (t = this) && t.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (t.DOMTokenList = function() {
            ...
            return function(i, s) {
                var r = this, a = [], l = {}, c = 0, t = 0, e = function(t) {
                    ...
                    if (n.length) {
                        for(e = 0; e < n.length; ++e)if (o.test(n[e])) throw (t = new SyntaxError('String "' + n[e] + '" contains an invalid character')).code = 5, t.name = "InvalidCharacterError", t;
                    }
                ...
                return d(), n(r, "length", function() {
                    ...
                    return d.apply(r, [
                        t
                    ]), o !== e ? e ? (r.add(t), !0) : (r.remove(t), !1) : l[t] ? (r.remove(t), !1) : (r.add(t), !0);
                }, r;
            };
        ...
        if (!e) {
            var n = this, u = !0, d = function(t, e, n, o) {
                Object.defineProperty ? Object.defineProperty(t, e, {
                    configurable: !1 === u || !!o,
                    get: n
                }) : t.__defineGetter__(e, n);
    ...
    o.prototype.init = function() {
        ...
        var t = document.createElement("span"), t = (t.classList.add(this.upChevronIconClass), this.$showAllButton.appendChild(t), document.createElement("div")), t = (t.setAttribute("class", this.controlsClass), t.appendChild(this.$showAllButton), this.$module.insertBefore(t, this.$module.firstChild), document.createElement("span"));
        ...
        var n = t.querySelector("." + this.sectionButtonClass), o = t.querySelector("." + this.sectionHeadingClass), i = t.querySelector("." + this.sectionSummaryClass), s = document.createElement("button");
        ...
        var t = document.createElement("span"), e = (t.classList.add(this.sectionHeadingTextClass), t.id = n.id, document.createElement("span")), e = (e.classList.add(this.sectionHeadingTextFocusClass), t.appendChild(e), e.innerHTML = n.innerHTML, document.createElement("span")), l = (e.classList.add(this.sectionShowHideToggleClass), e.setAttribute("data-nosnippet", ""), document.createElement("span")), c = (l.classList.add(this.sectionShowHideToggleFocusClass), e.appendChild(l), document.createElement("span")), u = document.createElement("span");
        if (u.classList.add(this.upChevronIconClass), l.appendChild(u), c.classList.add(this.sectionShowHideTextClass), l.appendChild(c), s.appendChild(t), s.appendChild(this.getButtonPunctuationEl()), null != i) {
            var d = document.createElement("span"), u = document.createElement("span");
            u.classList.add(this.sectionSummaryFocusClass), d.appendChild(u);
            for(var h = 0, p = i.attributes.length; h < p; ++h){
                var f = i.attributes.item(h).nodeName, m = i.attributes.item(h).nodeValue;
                d.setAttribute(f, m);
            }
        ...
        var n = e.querySelector("." + this.upChevronIconClass), o = e.querySelector("." + this.sectionShowHideTextClass), i = e.querySelector("." + this.sectionButtonClass), s = t ? this.i18n.t("hideSection") : this.i18n.t("showSection");
        o.innerText = s, i.setAttribute("aria-expanded", t);
        o = [
            e.querySelector("." + this.sectionHeadingTextClass).innerText.trim()
    ...
    o.prototype.storeState = function(t) {
        ...
        (function(t) {
            ...
            storagecommit: 1,
            textinput: 1
        }, "undefined" == typeof document) || "undefined" == typeof window || (t = window.Event && window.Event.prototype || null, window.Event = Window.prototype.Event = function Event1(t, e) {
            var n, o, i;
    ...
    d.prototype.init = function() {
        ...
        var n, t = this.$module, e = this.$summary = t.getElementsByTagName("summary").item(0), o = this.$content = t.getElementsByTagName("div").item(0);
    ...
    p.prototype.init = function() {
        ...
        if (e) {
            ...
            if (e.length) {
                ...
                var n = e.getBoundingClientRect().top, o = t.getBoundingClientRect();
        ...
        var e, n = window.location.hash, n = this.getTab(n);
        ...
        var e = this.getHref(t).slice(1), e = (t.setAttribute("id", "tab_" + e), t.setAttribute("role", "tab"), t.setAttribute("aria-controls", e), t.setAttribute("aria-selected", "false"), t.setAttribute("tabindex", "-1"), this.getPanel(t));
        ...
        t.preventDefault();
        var t = t.target, e = this.getCurrentTab();
        ...
        var t, e = this.getCurrentTab(), n = e.parentNode.nextElementSibling;
        ...
        var t, e = this.getCurrentTab(), n = e.parentNode.previousElementSibling;
        (t = n ? n.querySelector(".govuk-tabs__tab") : t) && (this.hideTab(e), this.showTab(t), t.focus(), this.createHistoryEntry(t));
        ...
        var t = "undefined" != typeof (e = void 0 !== e ? e : {}).scope ? e.scope : document, n = (i(t.querySelectorAll('[data-module="govuk-accordion"]'), function(t) {
            new o(t, e.accordion).init();
        }), t.querySelectorAll('[data-module="govuk-button"]')), n = (i(n, function(t) {
            new u(t, e.button).init();
        }), t.querySelectorAll('[data-module="govuk-character-count"]')), n = (i(n, function(t) {
            new p(t, e.characterCount).init();
        }), t.querySelectorAll('[data-module="govuk-checkboxes"]')), n = (i(n, function(t) {
            new f(t).init();
...
//# sourceMappingURL=index.64e23c9e.js.map
