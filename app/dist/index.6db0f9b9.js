(function(global1, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define("GOVUKFrontend", [
        "exports"
    ], factory) : factory(global1.GOVUKFrontend = {});
     ...
     */ var flattenObject = function(configObject) {
       ...
       */ var flattenLoop = function(obj, prefix) {
                ...
                for(var key in obj){
                    ...
                    if (typeof value === "object") // If the value is a nested object, recurse over that too
                    flattenLoop(value, prefixedKey);
                    else // Otherwise, add this value to our return object
        ...
        for(var i = 0; i < arguments.length; i++){
            ...
            for(var key in obj)if (Object.prototype.hasOwnProperty.call(obj, key)) formattedConfigObject[key] = obj[key];
        }
   ...
   */ function extractConfigByNamespace(configObject, namespace) {
        ...
        if (!configObject || typeof configObject !== "object") throw new Error('Provide a `configObject` of type "object".');
        if (!namespace || typeof namespace !== "string") throw new Error('Provide a `namespace` of type "string" to filter the `configObject` by.');
        var newObject = {};
        for(var key in configObject){
            ...
            if (Object.prototype.hasOwnProperty.call(configObject, key) && keyParts[0] === namespace) {
                ...
                if (keyParts.length > 1) keyParts.shift();
   ...
   */ (function(undefined) {
    ...
    (function(undefined) {
        ...
        var detect = function() {
            if (!document.documentElement.dataset) return false;
            ...
            get: function() {
                ...
                for(var i = 0; i < attributes.length; i++){
                    ...
                    if (attribute && attribute.name && /^data-\w[.\w-]*$/.test(attribute.name)) {
                        ...
                        if ("__defineGetter__" in Object.prototype && "__defineSetter__" in Object.prototype) Object.defineProperty(map, propName, {
                            enumerable: true,
                            get: (function() {
                                return this.value;
                            }).bind({
   ...
   */ function normaliseString(value) {
        ...
        if (trimmedValue.length > 0 && isFinite(trimmedValue)) return Number(trimmedValue);
        return value;
    }
    /**
   * Normalise dataset
   ...
   */ function normaliseDataset(dataset) {
        var out = {};
        for(var key in dataset)out[key] = normaliseString(dataset[key]);
        return out;
    }
    /**
   ...
   */ I18n.prototype.t = function(lookupKey, options) {
        if (!lookupKey) // Print a console error if no lookup key has been provided
        throw new Error("i18n: lookup key missing");
        // If the `count` option is set, determine which plural suffix is needed and
        // change the lookupKey to match. We check to see if it's undefined instead of
        // falsy, as this could legitimately be 0.
        if (options && typeof options.count !== "undefined") // Get the plural suffix
        ...
        if (lookupKey in this.translations) {
            ...
            if (translationString.match(/%{(.\S+)}/)) {
                if (!options) throw new Error("i18n: cannot replace placeholders in string if no option data provided");
                return this.replacePlaceholders(translationString, options);
            } else return translationString;
        } else // If the key wasn't found in our translations object,
   ...
   */ I18n.prototype.replacePlaceholders = function(translationString, options) {
        var formatter;
        if (this.hasIntlNumberFormatSupport()) formatter = new Intl.NumberFormat(this.locale);
        return translationString.replace(/%{(.\S+)}/g, function(placeholderWithBraces, placeholderKey) {
            if (Object.prototype.hasOwnProperty.call(options, placeholderKey)) {
                var placeholderValue = options[placeholderKey];
                // If a user has passed `false` as the value for the placeholder
                // treat it as though the value should not be displayed
                if (placeholderValue === false) return "";
                // If the placeholder's value is a number, localise the number formatting
                if (typeof placeholderValue === "number" && formatter) return formatter.format(placeholderValue);
                return placeholderValue;
            } else throw new Error("i18n: no data found to replace " + placeholderWithBraces + " placeholder in string");
        });
    };
    /**
   ...
   */ I18n.prototype.getPluralSuffix = function(lookupKey, count) {
        ...
        if (this.hasIntlPluralRulesSupport()) preferredForm = new Intl.PluralRules(this.locale).select(count);
        else preferredForm = this.selectPluralFormUsingFallbackRules(count);
        // Use the correct plural form if provided
        if (lookupKey + "." + preferredForm in this.translations) return preferredForm;
        else if (lookupKey + ".other" in this.translations) {
            if (console && "warn" in console) console.warn('i18n: Missing plural form ".' + preferredForm + '" for "' + this.locale + '" locale. Falling back to ".other".');
            return "other";
        // If the required `other` plural form is missing, all we can do is error
        } else throw new Error('i18n: Plural form ".other" is required for "' + this.locale + '" locale');
    };
    /**
   ...
   */ I18n.prototype.selectPluralFormUsingFallbackRules = function(count) {
        ...
        if (ruleset) return I18n.pluralRules[ruleset](count);
        return "other";
    };
    /**
   ...
   */ I18n.prototype.getPluralRulesForLocale = function() {
        ...
        for(var pluralRule in I18n.pluralRulesMap)if (Object.prototype.hasOwnProperty.call(I18n.pluralRulesMap, pluralRule)) {
            var languages = I18n.pluralRulesMap[pluralRule];
            for(var i = 0; i < languages.length; i++){
                if (languages[i] === locale || languages[i] === localeShort) return pluralRule;
            }
        }
    };
    /**
   ...
   */ I18n.pluralRules = {
        /* eslint-disable jsdoc/require-jsdoc */ arabic: function(n) {
            if (n === 0) return "zero";
            if (n === 1) return "one";
            if (n === 2) return "two";
   ...
   */ (function(undefined) {
        ...
        (function(global1) {
            ...
            if (!nativeImpl || !!document.createElementNS && !!document.createElementNS("http://www.w3.org/2000/svg", "svg") && !(document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList)) global1.DOMTokenList = function() {
                ...
                var _DOMTokenList = function(el, prop) {
                    ...
                    /** Helper function called at the start of each class method. Internal use only. */ var preop = function() {
                        var error;
                        var i;
                        var args = arguments;
                        var rSpace = /\s+/;
    ...
    (function(undefined) {
        ...
        (function(global1) {
            ...
            addProp(global1.Element, "classList", "className");
            addProp(global1.HTMLElement, "classList", "className");
            addProp(global1.HTMLLinkElement, "relList", "rel");
            addProp(global1.HTMLAnchorElement, "relList", "rel");
            addProp(global1.HTMLAreaElement, "relList", "rel");
        })(this);
    }).call("object" === typeof window && window || "object" === typeof self && self || "object" === typeof global && global || {});
    (function(undefined) {
    ...
    (function(undefined) {
        ...
        if (typeof WorkerGlobalScope === "undefined" && typeof importScripts !== "function") (function(global1) {
            if (global1.constructor) global1.Window = global1.constructor;
            else (global1.Window = global1.constructor = new Function("return function Window() {}")()).prototype = this;
        })(this);
    }).call("object" === typeof window && window || "object" === typeof self && self || "object" === typeof global && global || {});
    (function(undefined) {
        // Detection from https://github.com/Financial-Times/polyfill-service/blob/master/packages/polyfill-library/polyfills/Event/detect.js
        var detect = function(global1) {
            if (!("Event" in global1)) return false;
            if (typeof global1.Event === "function") return true;
            try {
        ...
        (function() {
            ...
            window.Event = Window.prototype.Event = function Event1(type, eventInitDict) {
   ...
   */ Accordion.prototype.initControls = function() {
        ...
        if ("onbeforematch" in document) document.addEventListener("beforematch", this.onBeforeMatch.bind(this));
    };
    /**
   ...
   */ Accordion.prototype.constructHeaderMarkup = function($header, index) {
        ...
        for(var i = 0; i < $span.attributes.length; i++){
            ...
            if (attr.nodeName !== "id") $button.setAttribute(attr.nodeName, attr.nodeValue);
        }
   ...
   */ Accordion.prototype.onBeforeMatch = function(event) {
        ...
        if ($section) this.setExpanded(true, $section);
    };
    /**
   ...
   */ Accordion.prototype.setExpanded = function(expanded, $section) {
        ...
        if ($headingText) ariaLabelParts.push($headingText.innerText.trim());
        var $summary = $section.querySelector("." + this.sectionSummaryClass);
        if ($summary) ariaLabelParts.push($summary.innerText.trim());
   ...
   */ Accordion.prototype.updateShowAllButton = function(expanded) {
        ...
        if (expanded) this.$showAllIcon.classList.remove(this.downChevronIconClass);
        else this.$showAllIcon.classList.add(this.downChevronIconClass);
    };
    var helper = {
        /**
   ...
   */ /* eslint-disable es-x/no-function-prototype-bind -- Polyfill imported */ var KEY_SPACE = 32;
   ...
   */ Button.prototype.debounce = function(event) {
        ...
        if (!this.config.preventDoubleClick) return;
   ...
   */ function CharacterCount($module, config) {
        ...
        var configOverrides = {};
        if ("maxwords" in datasetConfig || "maxlength" in datasetConfig) configOverrides = {
            maxlength: false,
            maxwords: false
        };
        ...
        if (this.config.maxwords) this.maxLength = this.config.maxwords;
        else if (this.config.maxlength) this.maxLength = this.config.maxlength;
        else return;
        this.$module = $module;
   ...
   */ CharacterCount.prototype.init = function() {
        ...
        if ($textareaDescription.innerText.match(/^\s*$/)) $textareaDescription.innerText = this.i18n.t("textareaDescription", {
        ...
        if ("onpageshow" in window) window.addEventListener("pageshow", this.updateCountMessage.bind(this));
        else window.addEventListener("DOMContentLoaded", this.updateCountMessage.bind(this));
   ...
   */ CharacterCount.prototype.handleFocus = function() {
        this.valueChecker = setInterval((function() {
            if (!this.lastInputTimestamp || Date.now() - 500 >= this.lastInputTimestamp) this.updateIfValueChanged();
        }).bind(this), 1000);
    };
    /**
   * Handle blur event
   ...
   */ CharacterCount.prototype.updateVisibleCountMessage = function() {
        ...
        // counter invisible.
        if (this.isOverThreshold()) $visibleCountMessage.classList.remove("govuk-character-count__message--disabled");
        else $visibleCountMessage.classList.add("govuk-character-count__message--disabled");
        // Update styles
   ...
   */ CharacterCount.prototype.updateScreenReaderCountMessage = function() {
        ...
        if (this.isOverThreshold()) $screenReaderCountMessage.removeAttribute("aria-hidden");
        else $screenReaderCountMessage.setAttribute("aria-hidden", true);
        // Update message
   ...
   */ CharacterCount.prototype.formatCountMessage = function(remainingNumber, countType) {
        if (remainingNumber === 0) return this.i18n.t(countType + "AtLimit");
   ...
   */ CharacterCount.prototype.isOverThreshold = function() {
        ...
        if (!this.config.threshold) return true;
        var $textarea = this.$textarea;
   ...
   */ Checkboxes.prototype.handleClick = function(event) {
        ...
        if ($clickedInput.type !== "checkbox") return;
        // If the checkbox conditionally-reveals some content, sync the state
        var hasAriaControls = $clickedInput.getAttribute("aria-controls");
        if (hasAriaControls) this.syncConditionalRevealWithInputState($clickedInput);
        // No further behaviour needed for unchecking
        if (!$clickedInput.checked) return;
        // Handle 'exclusive' checkbox behaviour (ie "None of these")
        var hasBehaviourExclusive = $clickedInput.getAttribute("data-behaviour") === "exclusive";
        if (hasBehaviourExclusive) this.unCheckAllInputsExcept($clickedInput);
        else this.unCheckExclusiveInputs($clickedInput);
    };
    /* eslint-disable es-x/no-function-prototype-bind -- Polyfill imported */ var KEY_ENTER = 13;
    var KEY_SPACE$1 = 32;
    /**
   * Details component
   *
   ...
   */ Details.prototype.polyfillDetails = function() {
        ...
        if (this.$module.hasAttribute("open")) $summary.setAttribute("aria-expanded", "true");
        else {
   ...
   */ function ErrorSummary($module, config) {
        ...
        if (!$module) // Little safety in case code gets ported as-is
   ...
   */ ErrorSummary.prototype.setFocus = function() {
        var $module = this.$module;
        if (this.config.disableAutoFocus) return;
   ...
   */ Header.prototype.init = function() {
        ...
        if ("matchMedia" in window) {
            ...
            if ("addEventListener" in this.mql) this.mql.addEventListener("change", this.syncState.bind(this));
            else // addListener is a deprecated function, however addEventListener
            // isn't supported by IE or Safari. We therefore add this in as
            // a fallback for those browsers
            this.mql.addListener(this.syncState.bind(this));
            this.syncState();
            this.$menuButton.addEventListener("click", this.handleMenuButtonClick.bind(this));
        } else this.$menuButton.setAttribute("hidden", "");
    };
    /**
   * Sync menu state
   *
   ...
   */ Header.prototype.syncState = function() {
        if (this.mql.matches) {
            ...
            if (this.menuIsOpen) this.$menu.removeAttribute("hidden");
   ...
   */ SkipLink.prototype.getLinkedElement = function() {
        ...
        if (!linkedElementId) return false;
   ...
   */ SkipLink.prototype.getFragmentFromUrl = function() {
        ...
        if (!this.$module.hash) return false;
   ...
   */ Tabs.prototype.onTabClick = function(event) {
        if (!event.target.classList.contains("govuk-tabs__tab")) // Allow events on child DOM elements to bubble up to tab parent
        return false;
        event.preventDefault();
   ...
   */ function initAll(config) {
        ...
        if ($errorSummary) new ErrorSummary($errorSummary, config.errorSummary).init();
        // Find first header module to enhance.
        var $header = $scope.querySelector('[data-module="govuk-header"]');
        if ($header) new Header($header).init();
   ...
   */ exports1.initAll = initAll;
    exports1.Accordion = Accordion;
    exports1.Button = Button;
    exports1.Details = Details;
    exports1.CharacterCount = CharacterCount;
    exports1.Checkboxes = Checkboxes;
    exports1.ErrorSummary = ErrorSummary;
    exports1.Header = Header;
    exports1.NotificationBanner = NotificationBanner;
    exports1.Radios = Radios;
    exports1.SkipLink = SkipLink;
    exports1.Tabs = Tabs;
});

//# sourceMappingURL=index.6db0f9b9.js.map
